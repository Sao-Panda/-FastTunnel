...
```
你的应用 ──→ 本地代理(你的本机地址:9080) ──→ [可选]远程网关(你的VPS固定IP) ──→ 海外API
```

> 所有地址都是**使用者自己的**：本地代理跑在你自己的电脑上，远程网关跑在你自己的 VPS 上。
...
| 地址 | 说明 |
|------|------|
| `你的本机地址:8580` | 管理面板 — 跑在**你自己的电脑**上 |
| `你的本机地址:9080` | 本地代理 — 跑在**你自己的电脑**上 |
| 你的 VPS IP:8080 | 远程网关 — 跑在**你自己的 VPS** 上 |

> 程序中所有地址都属于使用者自己，没有任何外部 IP。
